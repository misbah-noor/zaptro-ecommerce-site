...
const Contact = () => {
  return (
    <div className="min-h-screen bg-gradient-to-r from-[#0f0c29] via-[#302b63] to-[#24243e] flex items-center justify-center py-10 px-4">
      <div className="backdrop-blur-md bg-white/10 border border-white/20 rounded-2xl shadow-2xl p-10 w-full max-w-5xl">
        <h2 className="text-4xl font-bold text-white text-center mb-12">Get in Touch with <span className="text-red-400">Zaptro</span></h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="text-white space-y-7">
            <div>
              ...
              <p className="text-gray-300">Have a question or need support? We're here to help you with your ecommerce journey.</p>
            </div>
            <div>
              <p><strong>📍 Address:</strong> 123 Tech Lane, Lahore, Pakistan</p>
              <p><strong>📧 Email:</strong> support@zaptro.com</p>
              <p><strong>📞 Phone:</strong> +92 12342 43210</p>
            </div>
          </div>
          ...
          <form className="space-y-6">
            <div>
              ...
              <input type="text" placeholder="John Doe" className="w-full px-4 py-2 bg-white/30 border border-white/30 text-white rounded-xl placeholder-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500" />
            </div>
            <div>
